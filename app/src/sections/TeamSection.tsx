...
export function TeamSection() {
  ...
  // Visa endast kategorier på startsidan eller om ingen kategori är vald på /personal
  const showOnlyCategories = !location.pathname.startsWith('/personal') || selectedCategories.length === 0;
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="mb-8" ref={categoryFiltersRef}>
                  ...
                  return (
                    <button
                      ...
                      onClick={() => {
                        ...
                        if (!isSelected && location.pathname.startsWith('/personal')) {
              ...
              {/* Visa valda kategorier och rensa-knapp endast på /personal */}
              {location.pathname.startsWith('/personal') && selectedCategories.length > 0 && (
            ...
            {/* Visa personal endast om kategori är vald på /personal */}
            {location.pathname.startsWith('/personal') && selectedCategories.length > 0 && (
              <>
                ...
                {/* Profile modal shown when selectedMember set */}
                {selectedMember && (
